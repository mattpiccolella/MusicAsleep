...
public class CameraClass extends Activity{
	...
	public void CreateView(){
		LayoutParams FILL_PARENT = new LayoutParams(
          		LayoutParams.FILL_PARENT,
          		LayoutParams.FILL_PARENT);
		
		LayoutParams WRAP_CONTENT = new LayoutParams(
          		LayoutParams.WRAP_CONTENT,
          		LayoutParams.WRAP_CONTENT);
		
		LayoutParams BTN_WRAP_CONTENT = new LayoutParams(
          		LayoutParams.FILL_PARENT,
          		LayoutParams.WRAP_CONTENT,0.5f);
		
		LayoutParams WIDTH_FIIL_PARENT = new LayoutParams(
          		LayoutParams.FILL_PARENT,
          		LayoutParams.WRAP_CONTENT);
        ...
        imgCapture.setImageResource(R.drawable.ic_launcher);
